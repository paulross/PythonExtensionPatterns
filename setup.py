...
setup(
    ...
    ext_modules=[
        ...
        Extension(f"{PACKAGE_NAME}.cRefCount",
                  include_dirs=['/usr/local/include', 'src/cpy/Containers', 'src/cpy', ],
                  sources=['src/cpy/RefCount/cRefCount.c', 'src/cpy/Containers/DebugContainers.c', ],
                  extra_compile_args=extra_compile_args_c,
                  language='c',
                  ),
        ...
        Extension(name=f"{PACKAGE_NAME}.cWatchers",
